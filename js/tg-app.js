...
(function () {
  ...
  function listScreen(direction) {
    ...
    return h('section', { 'aria-label': 'Программы' }, [
      // Надстрочник называет только университет: факультет с 23.09.2026
      // стоит в самом имени центра строкой ниже, и прежнее «Факультет права
      // НИУ ВШЭ» повторяло его дважды подряд.
